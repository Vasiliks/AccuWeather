...
PLUGIN_DIR = 'Extensions.AccuWeather'
	...
	for lang in os.listdir('po'):
		if lang.endswith('.po'):
			...
			if not os.path.exists(destdir):
				os.makedirs(destdir)
			dest = os.path.join(destdir, 'AccuWeather.mo')
...
setup(name = 'enigma2-plugin-extensions-accuweather',
		...
		packages=[PLUGIN_DIR],
		package_data={PLUGIN_DIR: ['images/*','images/*/*', 'skins/*.xml', 'locale/*/LC_MESSAGES/*.mo']},
		description = 'AccuWeather Forecast plugin',
	)
